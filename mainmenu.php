...
<head>
    ...
    <title>Main Menu - Anggota Kelompok 4</title>
    <style>
        ...
        .server-indicator { font-size: 20px; font-weight: bold; background: <?php echo $text_color; ?>; color: white; padding: 10px 20px; border-radius: 8px; }
...
<body>
    ...
    <div class="table-container">
        <h3>Daftar Anggota Kelompok (Data Terintegrasi Database Server)</h3>
        <table>
            <thead>
                <tr>
                    <th>Nama Anggota</th>
